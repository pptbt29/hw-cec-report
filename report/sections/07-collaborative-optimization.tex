...
\tabrowrule
15 & CES-CB \cite{li2025cloud} & TSC 2025 & Request / Workflow Routing -- Runtime State Management & request cost prediction；edge batch selection & 利用 prompt embedding 和历史执行数据预测请求成本，在 edge/cloud 间选择请求集合，说明 routing 会影响队列阻塞和 batch 组成 \\
\tabrowrule
