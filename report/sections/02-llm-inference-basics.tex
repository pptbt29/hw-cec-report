...
基于这些工作，本报告进一步整合形成 LLM 推理优化方向的 \textbf{Layer–Scope Taxonomy}：以主要优化对象所在的系统抽象层为主轴，将方法分为 Model-Level、Kernel-Level、Runtime-Level 和 Serving Policy \& Routing-Level；同时以执行范围为副轴，区分 Local 与 Distributed。后续 2.3.1--2.3.4 将依次介绍四个层级，并在每个层级中讨论其本地与分布式实现。
